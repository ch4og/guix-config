...
(define rust-librespot-audio-0.8.0.28bcb23
  ...
  (origin
    ...
    (uri (git-reference
          ...
          (commit "28bcb231fe26f4db682eb85d1f7ae43aa1a83896")))
    (file-name (git-file-name "rust-librespot-audio" "0.8.0.28bcb23"))
    (sha256 (base32 "0ph5gh9jg5w6q3c1nlp86jyw8xrg55crzqhd4w310byj8xpw1s2r"))))
...
(define rust-librespot-connect-0.8.0.28bcb23
  ...
  (origin
    ...
    (uri (git-reference
          (url "https://github.com/LargeModGames/spotatui-librespot")
          (commit "28bcb231fe26f4db682eb85d1f7ae43aa1a83896")))
    (file-name (git-file-name "rust-librespot-connect" "0.8.0.28bcb23"))
    (sha256 (base32 "0ph5gh9jg5w6q3c1nlp86jyw8xrg55crzqhd4w310byj8xpw1s2r"))))
...
(define rust-librespot-core-0.8.0.28bcb23
  ...
  (origin
    ...
    (uri (git-reference
          (url "https://github.com/LargeModGames/spotatui-librespot")
          (commit "28bcb231fe26f4db682eb85d1f7ae43aa1a83896")))
    (file-name (git-file-name "rust-librespot-core" "0.8.0.28bcb23"))
    (sha256 (base32 "0ph5gh9jg5w6q3c1nlp86jyw8xrg55crzqhd4w310byj8xpw1s2r"))))
...
(define rust-librespot-metadata-0.8.0.28bcb23
  ...
  (origin
    ...
    (uri (git-reference
          (url "https://github.com/LargeModGames/spotatui-librespot")
          (commit "28bcb231fe26f4db682eb85d1f7ae43aa1a83896")))
    (file-name (git-file-name "rust-librespot-metadata" "0.8.0.28bcb23"))
    (sha256 (base32 "0ph5gh9jg5w6q3c1nlp86jyw8xrg55crzqhd4w310byj8xpw1s2r"))))
...
(define rust-librespot-oauth-0.8.0.28bcb23
  ...
  (origin
    ...
    (uri (git-reference
          (url "https://github.com/LargeModGames/spotatui-librespot")
          (commit "28bcb231fe26f4db682eb85d1f7ae43aa1a83896")))
    (file-name (git-file-name "rust-librespot-oauth" "0.8.0.28bcb23"))
    (sha256 (base32 "0ph5gh9jg5w6q3c1nlp86jyw8xrg55crzqhd4w310byj8xpw1s2r"))))
...
(define rust-librespot-playback-0.8.0.28bcb23
  ...
  (origin
    ...
    (uri (git-reference
          (url "https://github.com/LargeModGames/spotatui-librespot")
          (commit "28bcb231fe26f4db682eb85d1f7ae43aa1a83896")))
    (file-name (git-file-name "rust-librespot-playback" "0.8.0.28bcb23"))
    (sha256 (base32 "0ph5gh9jg5w6q3c1nlp86jyw8xrg55crzqhd4w310byj8xpw1s2r"))))
...
(define rust-librespot-protocol-0.8.0.28bcb23
  ...
  (origin
    ...
    (uri (git-reference
          (url "https://github.com/LargeModGames/spotatui-librespot")
          (commit "28bcb231fe26f4db682eb85d1f7ae43aa1a83896")))
    (file-name (git-file-name "rust-librespot-protocol" "0.8.0.28bcb23"))
    (sha256 (base32 "0ph5gh9jg5w6q3c1nlp86jyw8xrg55crzqhd4w310byj8xpw1s2r"))))
...
(define rust-maxminddb-0.28.1
  (crate-source "maxminddb" "0.28.1"
                "1pa6qmsbc12apr90rsqx4nrhbxigmz5yvg48wmqmn1dd51s4dxps"))
...
(define rust-ratatui-0.30.1
  (crate-source "ratatui" "0.30.1"
                "0s3b1w896rb6bf7sws1qj12kbd40lfjywz48ijb38nvk7a77958n"))
...
(define rust-ratatui-core-0.1.1
  (crate-source "ratatui-core" "0.1.1"
                "0i3b6fjf3l57qr271hhhf8mkgms207k60y54bxcqrfjb6lzn1ls2"))
...
(define rust-ratatui-crossterm-0.1.1
  (crate-source "ratatui-crossterm" "0.1.1"
                "034q56si2hq8gd8l9667c1vc03kkgdl2lrzqlh66jsmxvjz6fa1b"))
...
(define rust-ratatui-macros-0.7.1
  (crate-source "ratatui-macros" "0.7.1"
                "07cgqirawiyhsfzcmbc1hrrbwjd2z88z8390kpc9153742bwbyl0"))

(define rust-ratatui-termwiz-0.1.1
  (crate-source "ratatui-termwiz" "0.1.1"
                "0rw9miywnsr8czj447wf83dzr8k1jxa6vicijd84kmsfyzw8ysrq"))

(define rust-ratatui-widgets-0.3.0
  (crate-source "ratatui-widgets" "0.3.0"
                "1nqjcrskazvfgjkmmsifliqrvap8bw6850rlap109rnl7h1gmnyp"))

(define rust-ratatui-widgets-0.3.1
  (crate-source "ratatui-widgets" "0.3.1"
                "176pf59m55b8jf8m3yl8dbz4pvhyqq1hm4ibvidbyfmcsxyz3x3y"))
...
(define-cargo-inputs lookup-cargo-inputs
                     ...
                     (xrat =>
                           (list rust-adler2-2.0.1
                                 ...
                                 rust-rand-core-0.9.5
                                 rust-ratatui-0.30.1
                                 rust-ratatui-core-0.1.1
                                 rust-ratatui-crossterm-0.1.1
                                 rust-ratatui-macros-0.7.1
                                 rust-ratatui-termwiz-0.1.1
                                 rust-ratatui-widgets-0.3.1
                                 rust-redox-syscall-0.5.18
